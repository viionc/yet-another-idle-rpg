...
// inventory
export const updatePlayerInventoryAction = createAction('[Player] Update Inventory', props<{
    items: InventoryItem[]
}>())
export const removeItemFromInventoryAction = createAction('[Player] Remove Item From Inventory', props<{
    id: ItemID,
    tier: ItemTier
}>())
...
export const unequipItemFromSlotAction = createAction('[Player] Unequip Item From Slot', props<{
    slot: EquipmentSlotKey
}>())
export const equipItemToSlotAction = createAction('[Player] Equip Item To Slot', props<{
    id: ItemID,
    slot: EquipmentSlotKey,
    tier: ItemTier
}>())
